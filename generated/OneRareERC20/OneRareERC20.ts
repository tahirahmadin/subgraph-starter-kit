...
export class RecoverToken extends ethereum.Event {
  get params(): RecoverToken__Params {
    return new RecoverToken__Params(this);
  }
}

export class RecoverToken__Params {
  _event: RecoverToken;

  constructor(event: RecoverToken) {
    this._event = event;
  }
...
export class OneRareERC20 extends ethereum.SmartContract {
  static bind(address: Address): OneRareERC20 {
    return new OneRareERC20("OneRareERC20", address);
  }
